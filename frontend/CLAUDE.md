...
- `src/components/` — presentational + chrome components (Icon, Sparkline, CostDistributionChart, TimeCostPanel, CostHistoryModal, SpatialMap, Illustrations, Sidebar, TopBar, UserMenu, Tabs, StateView)
